                ...
                switch(CMD){
                        ...
                        String consignee = null;
                            try {
                                ...
                                System.out.println("Memuat File....");
                                ...
                                System.out.println("File telah disimpan: "+ path);
                            } catch (IOException e) {
                                DataOutputStream eDos = new DataOutputStream(socket.getOutputStream());
                                eDos.writeUTF("CMD_SENDFILERESPONSE "+ consignee + " Koneksi terputus, silakan coba lagi.!");
                                System.out.println(e.getMessage());
                                main.setMyTitle("Anda telah masuk sebagai: " + main.getMyUsername());
