...
public class SendFile extends javax.swing.JFrame {
                ...
                while (!Thread.currentThread().isInterrupted()) {
                    ...
                    switch (cmd) {
                        case "CMD_RECEIVE_FILE_ERROR":
                            ...
                            JOptionPane.showMessageDialog(SendFile.this, msg, "Kesalahan", JOptionPane.ERROR_MESSAGE);
                            this.closeMe();
                            break;
                        ...
                        case "CMD_SENDFILEERROR":
                            ...
                            JOptionPane.showMessageDialog(SendFile.this, emsg, "Kesalahan", JOptionPane.ERROR_MESSAGE);
                            form.updateAttachment(false);
                            form.disableGUI(false);
                            form.updateBtn("Kirim File");
                            break;
                        case "CMD_SENDFILERESPONSE":
                            ...
                            form.updateAttachment(false);
                            JOptionPane.showMessageDialog(SendFile.this, rMsg, "Kesalahan", JOptionPane.ERROR_MESSAGE);
                            dispose();
                            break;
                    }
                }
    ...
    private void btnSendFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendFileActionPerformed
        ...
        if ((sendTo.length() > 0) && (file.length() > 0)) {
            ...
            JOptionPane.showMessageDialog(this, "Jangan biarkan kosong.!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
        }
